...
var dijkstra = &cobra.Command{
	Use:   "dijkstra",
	Short: "Execute the dijkstra algorithm on the given graph file",
	Long:  "",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		path, pathWeight := graph.Dijkstra(sourceNode, targetNode, viper.GetBool("verbose"))
